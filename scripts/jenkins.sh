...
sudo cat /tmp/mydaemon.json  >> /etc/docker/daemon.json
sudo  mv /usr/share/maven/conf/*  /mnt && sudo cat /tmp/mvn_sonar_settings.xml > /usr/share/maven/conf/settings.xml
